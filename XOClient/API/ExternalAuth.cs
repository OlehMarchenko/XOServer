...
namespace XOClient.API
{
    internal class ExternalAuth
    {
        ...
        public string[] Google_Auth()
        {
            ...
            var login = new GoogleLogin("282890727966-fnsa1tofldqjseo801t93i8lah4bijko.apps.googleusercontent.com",
                "rK8eRcFoO6CjYP9PmrwUczZW", "https://www.googleapis.com/auth/plus.login", autoLogout: true, loadUserInfo: true);
            login.ShowDialog();
